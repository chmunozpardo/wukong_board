...
HD_PWD='C:/Users/chmun/Programming/Artix7/DDR_UART/DDR_UART.runs/clk_wiz_72m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_72m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_72m.tcl
